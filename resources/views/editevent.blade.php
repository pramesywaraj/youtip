...
<div class="container pad">
    ...
    <div class="container col-5">
        <form method="POST" action="{{ route('edit.event', $show->id) }}" enctype="multipart/form-data">
					@csrf
            ...
            <input name="_method" type="hidden" value="PATCH">                    
                <img src="{{ asset('image/event/'.$show->image)  }}" style="max-height:200px;max-width:200px;margin-top:10px;">
                    <div class="row">
